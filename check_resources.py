...
dlib_facial_landmark_model_url = "https://osdn.net/projects/sfnet_dclib/downloads/dlib/v18.10/shape_predictor_68_face_landmarks.dat.bz2/"

# Note: old link does not work anymore so download the v18.10 shape_predictor_68_face_landmarks.dat.bz2
# manually into the dlib_models
...
def download_file(url, dest):
    ...
    print("Downloading: {}s Size: {}s (~{}4.2fMB)".format(file_name, file_size, (file_size/1024./1024.)))
